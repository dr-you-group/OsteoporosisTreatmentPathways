...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40222445)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40222445)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1557272,1552929,1512480,1513103,1516800,1436678,1521987,1578445,1594148,44506794,1511646,1511251,1524674)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1557272,1552929,1512480,1513103,1516800,1436678,1521987,1578445,1594148,44506794,1511646,1511251,1524674)
  and c.invalid_reason is null
...
from 
(
  select de.person_id, de.drug_exposure_id, de.drug_exposure_start_date, de.drug_exposure_end_date, de.drug_concept_id, datediff(day, de.drug_exposure_start_date, de.drug_exposure_end_date)+1 as 'days_supply' , de.visit_occurrence_id
