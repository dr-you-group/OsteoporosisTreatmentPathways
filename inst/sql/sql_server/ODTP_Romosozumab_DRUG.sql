...
select @target_cohort_id as cohort_definition_id, de.person_id, de.drug_concept_id, de.drug_exposure_start_date, de.drug_exposure_end_date,  datediff(day, de.drug_exposure_start_date, de.drug_exposure_end_date)+1 as 'days_supply', 30 as 'duration'
