...
#
# This file is part of BoneTreatmentPathways
#
...
OhdsiRTools::checkUsagePackage("BoneTreatmentPathways")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/BoneTreatmentPathways.pdf")
shell("R CMD Rd2pdf ./ --output=extras/BoneTreatmentPathways.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "BoneTreatmentPathways")
...
OhdsiRTools::createRenvLockFile("BoneTreatmentPathways")
